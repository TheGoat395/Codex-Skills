...
REQUIRED = ['classification', 'scope', 'exclusions', 'repository', 'release_id', 'environments', 'ownership', 'secrets_owner', 'content_owner', 'analytics_consent_owner', 'qa_evidence', 'monitoring', 'backup_restore', 'rollback', 'licenses', 'support', 'unresolved_risks', 'untested', 'domain_dns_owner', 'forms_owner']
EMPTY_LISTS = ['unresolved_risks', 'untested']
SKILL = 'final-client-handoff'
