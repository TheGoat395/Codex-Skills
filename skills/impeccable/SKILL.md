...
Aim for ready-to-ship, production-grade code rather than prototypes or loose starting points. Take no shortcuts unless the user asks for them. Drive toward a complete implementation that is beautiful, responsive, fast, precise, on brand, and accompanied by verification steps and clear known limitations. Treat every page, section, or component as something that should be reviewed with the tools available: browser screenshots, rendered inspection, console checks, accessibility checks, and responsive testing where possible.
...
**Codex-specific defects** (common generation giveaways; refuse-and-rewrite):
...
- **`border-radius: 32px+` on cards / sections / inputs.** Over-rounded cards look generic. Cards top out at 12–16px; full-pill is fine for tags/buttons. Picking 24/28/32/40px on a card is a common tell; no brand wants "insanely rounded" by default.
