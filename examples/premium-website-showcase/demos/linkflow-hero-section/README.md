...
Modern SaaS-style hero section for a link/workflow automation product.
...
```text
examples/premium-website-showcase/demos/linkflow-hero-section/preview.html
```

Optional local server from the repository root:

```bash
cd examples/premium-website-showcase/demos/linkflow-hero-section
