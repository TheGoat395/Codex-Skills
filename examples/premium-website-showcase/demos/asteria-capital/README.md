...
Renamed/cleaned capital landing page with a polished premium finance feel.
...
```text
examples/premium-website-showcase/demos/asteria-capital/preview.html
```

Optional local server from the repository root:

```bash
cd examples/premium-website-showcase/demos/asteria-capital
